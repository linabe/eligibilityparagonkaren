...
## Created variables
```{r codecreatevarspre, code = readLines("../munge/02-varsPreImp.R"), echo = TRUE, eval = FALSE}

```
[@nephro]
```{r codecreatevarspost, code = readLines("../munge/04-varsPostImp.R"), echo = TRUE, eval = FALSE}
...
In order to evaluate exclusion criteria 27 "History or presence of any other disease with a life expectancy of <3 years" we considered patients who actually died from a non-CV cause within 3 years from the registration in SwedeHF (and had 3 years follow-up) as not eligible. 
