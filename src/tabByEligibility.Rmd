...
tabElFunc <- function(pop, nofda = FALSE, nr = NULL, export = FALSE, exportname) {
  ...
  colnames(all) <- c(
    rep(c("Eligible", "Not eligible", "p-value"), ifelse(nofda, 6, 9))
  )
  ...
  myHeader2 <- c(" " = 1, "Literal scenario" = 9, "Pragmatic scenario" = 9, "FDA scenario" = 9)
  names(myHeader2) <- c(" ", "Literal scenario", "Pragmatic scenario", "FDA scenario")
  }
