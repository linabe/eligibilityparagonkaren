...
incexlFuncfda <- function(pop, exportname, export = FALSE) {
  ...
  flowtab <- rbind(flowtab, funcSumIEAll(
    "Eligible (EF 64/62% scenario) all criteria",
    "^ef6462_ie_in3|^ie_in_pragscen_in5",
    impdata_tmp, pdata_tmp
  ))
  ...
  if (export) {
    write.xlsx(flowtab, paste0("./output/tabs/tabincexcef6462_karen_", exportname, "_", Sys.Date(), ".xlsx"),
      rowNames = FALSE
    )
  }
